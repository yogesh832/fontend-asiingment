...
const notices = [
    ...
    {
      title: "Revised Proposed Datesheet for End Term Theory Examinations (Dec 2024 Jan 2025)",
    ...
    {
      title: "New enrollment numbers of upgraded students of B.Tech admitted in 2023-27.",
    ...
    {
      title: "Reappear Notice alongwith All Branches combined Student List October-2024",
    ...
    {
      title: "Revise Final List of Admitted students in mq after second counselling B.Tech",
      url: "https://bpitindia.ac.in/wp-content/uploads/2024/08/Revised-List-B.Tech-24_compressed.pdf",
    },
    {
      title: "Final List of Admitted students in mq after second counselling B.Tech",
      url: "https://bpitindia.ac.in/wp-content/uploads/2024/08/B.Tech-Final-List.pdf",
    },
    {
      title: "Final List of Admitted students in mq after second counselling B.Tech LE",
        ...
        <div className="border-4 border-[#98C3D6] font-serif p-4 pt-1 rounded-lg shadow-lg">
          ...
          <div className="flex flex-col gap-4">
            {notices.map((notice, index) => (
              <div
                key={index}
                className="w-full border border-[#C9DEE7] rounded-md p-1 text-center shadow-[#C9DEE7] shadow-md "    
              >
                ...
                {notice.date && (
                  <div className=" mt-1 text-xs text-red-500">
                   <marquee behavior="scroll" direction="left"> <span className="date-marquee-text">{notice.date}</span></marquee>
                  </div>
                )}
                {notice.marqueeText && (
                  <div className="apply-marquee-container overflow-hidden text-sm font-bold text-green-500 mt-1">
                    <span className="apply-marquee-text">{notice.marqueeText}</span>
                  </div>
                )}
              </div>
            ))}
